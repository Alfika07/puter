...
* add OpenAI support to text-to-speech ([#1853](https://github.com/Alfika07/puter/issues/1853)) ([861aedd](https://github.com/Alfika07/puter/commit/861aeddf3ec1c90b6ba4fdef3df71ef8bf34507d))
* add speech2text ([#1855](https://github.com/Alfika07/puter/issues/1855)) ([64f86da](https://github.com/Alfika07/puter/commit/64f86daddb8afb80980f35fc5f40a2974e1b7648))
* alert when going over usage limits significantly + egress metering ([#1782](https://github.com/Alfika07/puter/issues/1782)) ([27f2411](https://github.com/Alfika07/puter/commit/27f24118f34129e4083d4ba10b6d57fce4456593))
* allow for unlimitedAllowList + typedefs snuck in by accident ([#1813](https://github.com/Alfika07/puter/issues/1813)) ([219fd22](https://github.com/Alfika07/puter/commit/219fd2274cbf71aeeb3744810c3a26cbbc880b3f))
* devCenter open ui message ([#1850](https://github.com/Alfika07/puter/issues/1850)) ([0bb1426](https://github.com/Alfika07/puter/commit/0bb14261c2e0c7cc69ea0a03b367fefa01334d7f))
* dynamo in oss ([#2195](https://github.com/Alfika07/puter/issues/2195)) ([a1689c4](https://github.com/Alfika07/puter/commit/a1689c4ea3372c2224cae159f530af74a51c2f15))
* give referrals ([#2262](https://github.com/Alfika07/puter/issues/2262)) ([d64bd21](https://github.com/Alfika07/puter/commit/d64bd21a99f02ae9fd69d7f66da9d102298d27c8))
* implement redirect for hosting base domain ([4d60168](https://github.com/Alfika07/puter/commit/4d60168d2f13633cc187fa7015d63ad7ac541472)), closes [#2214](https://github.com/Alfika07/puter/issues/2214)
* introduce `PANEL_WIDTH` constant and refactor `UIWindow` for panel handling ([#1780](https://github.com/Alfika07/puter/issues/1780)) ([eb123d8](https://github.com/Alfika07/puter/commit/eb123d873f311374c4d5068ec898ad419a430496))
* KV testing ([#2061](https://github.com/Alfika07/puter/issues/2061)) ([f6fa17a](https://github.com/Alfika07/puter/commit/f6fa17a57540a8e739b9a33b004536e17be9a395))
* kv.remove feature to remove nested elements or list indices ([#2258](https://github.com/Alfika07/puter/issues/2258)) ([f88ca5d](https://github.com/Alfika07/puter/commit/f88ca5d4bd49055ceef4b11591e2fdb6241c2e4c))
* limit alerting ([#1798](https://github.com/Alfika07/puter/issues/1798)) ([6bbd9bd](https://github.com/Alfika07/puter/commit/6bbd9bdc9f367ef260e8620673ebc7418f89bcd7))
* meter ll_read for the person reading ([#1854](https://github.com/Alfika07/puter/issues/1854)) ([62b6582](https://github.com/Alfika07/puter/commit/62b6582d854d48be8664edaf6a1868ed059562f4))
* MeteringService test fixes for now ([#2050](https://github.com/Alfika07/puter/issues/2050)) ([93eddd2](https://github.com/Alfika07/puter/commit/93eddd2238bab5fdf2d19b789895437bb4888449))
* meteringService test suite ([#2052](https://github.com/Alfika07/puter/issues/2052)) ([59e6418](https://github.com/Alfika07/puter/commit/59e6418b005abad03bbe06c895ed767606453c5a))
* method for updating users metering directly ([#2252](https://github.com/Alfika07/puter/issues/2252)) ([b1e7bc5](https://github.com/Alfika07/puter/commit/b1e7bc5fca8b93dae82d161a378ffba38f553bfc))
* new kvstore operatios for more granular updates :rocket: ([#2254](https://github.com/Alfika07/puter/issues/2254)) ([23d7b75](https://github.com/Alfika07/puter/commit/23d7b751b92233dfb0e4f8d7c6a23f5c52db800e))
* rawBody parser, user  metadata column + other misc fixes ([#1904](https://github.com/Alfika07/puter/issues/1904)) ([5ff8c7e](https://github.com/Alfika07/puter/commit/5ff8c7e0409f0427293c676213608309824af549))
* refactor ai to have single entry point and follow defined model structure ([#2114](https://github.com/Alfika07/puter/issues/2114)) ([e2ae313](https://github.com/Alfika07/puter/commit/e2ae3135893d979af40606429dfc150331c4e864))
* rename ai models to match norm ([#2121](https://github.com/Alfika07/puter/issues/2121)) ([9da8aa0](https://github.com/Alfika07/puter/commit/9da8aa08493d9d85b1406f68a09caf1d1f7a65ab))
* rename meteringAndBilling to metering ([#1800](https://github.com/Alfika07/puter/issues/1800)) ([16fd614](https://github.com/Alfika07/puter/commit/16fd614b8486737154d4cc3b12a40e55942f511d))
* route for global usage aggregate ([#1810](https://github.com/Alfika07/puter/issues/1810)) ([256189a](https://github.com/Alfika07/puter/commit/256189a7def735dcbd571eedd10e083bd67a7dc0))
* Settings and modal UI/UX improvements ([#1828](https://github.com/Alfika07/puter/issues/1828)) ([1919163](https://github.com/Alfika07/puter/commit/191916321be77502f77927a005edbb103f92a599))
* shard apps as well to avoid hot partitions ([#1799](https://github.com/Alfika07/puter/issues/1799)) ([435d266](https://github.com/Alfika07/puter/commit/435d26608a07265b0142110c226976bfa889589f))
* single image ai endpoint ([#2129](https://github.com/Alfika07/puter/issues/2129)) ([161ca74](https://github.com/Alfika07/puter/commit/161ca74aa3d55be5bd1db11b40a1343aa046e663))
* support extension divs headers and tags being inserted to puter homepage load ([#2221](https://github.com/Alfika07/puter/issues/2221)) ([6cc86ff](https://github.com/Alfika07/puter/commit/6cc86ff58b5641ca30b1a9475abf65073a6a1c88))
* ui for dev account + util decorators for controllers in extension ([#1864](https://github.com/Alfika07/puter/issues/1864)) ([6037469](https://github.com/Alfika07/puter/commit/603746951b8da41ccce9a5b9301e5dcc1e8b1508))


### Bug Fixes

* access internal ID without assuming fetch ([a44e1fc](https://github.com/Alfika07/puter/commit/a44e1fc0743948203139781e1968c77012c34914))
* according to jquery spec, this is more robust ([52d4ca6](https://github.com/Alfika07/puter/commit/52d4ca6caf709955444065aadeeb02bacc00006c))
* add back non-functional changes ([#1888](https://github.com/Alfika07/puter/issues/1888)) ([93aaeef](https://github.com/Alfika07/puter/commit/93aaeef9e0b206289749e44c3a6cc1e83616890d))
* add catch all for minimum usage amounts ([#2248](https://github.com/Alfika07/puter/issues/2248)) ([2ef9aa3](https://github.com/Alfika07/puter/commit/2ef9aa3fb1abe5e3f08ce9a247085a411c039d04))
* Add debounce to toolbar reveal when dragging windows to prevent accidental activation ([#1989](https://github.com/Alfika07/puter/issues/1989)) ([f6139bc](https://github.com/Alfika07/puter/commit/f6139bc79aa4dd1c08ad0659b540c7f22136bb37))
* add missing 'tel' runtime module ([6d36c90](https://github.com/Alfika07/puter/commit/6d36c900328165d122edb5bfe2a5e3ca1f2a4c05))
* add missing Context import to IconResult ([71a2615](https://github.com/Alfika07/puter/commit/71a26156bd6dc9075b4b24fb24d41cf9b7170a48))
* add missing ref to `next()` ([5062e3c](https://github.com/Alfika07/puter/commit/5062e3c5ed6e33f80b9086473f1eb2d7e859cf9a))
* add simple 30s cache to /healthcheck ([cb7c83f](https://github.com/Alfika07/puter/commit/cb7c83f67024c3af4cb127f0717838d39e74dc66))
* adding more benign changes ([#1891](https://github.com/Alfika07/puter/issues/1891)) ([85432c8](https://github.com/Alfika07/puter/commit/85432c886e838b9e2012dc08440e4b81b5d0a428))
* allow mysql json object response ([#1918](https://github.com/Alfika07/puter/issues/1918)) ([0fd7100](https://github.com/Alfika07/puter/commit/0fd7100795619a667c2351cf559a0d4e208a9e4f))
* allow stripe header and commit db migration ([#1877](https://github.com/Alfika07/puter/issues/1877)) ([71fb04c](https://github.com/Alfika07/puter/commit/71fb04cd55130eae840ccfe8b2b3728f8b523037))
* also check this.entry.id when checking mysql_id ([cc7369d](https://github.com/Alfika07/puter/commit/cc7369d9d71b72b97929a2f1387c4f006bab5832))
* backend tests breaking with permision ([#2067](https://github.com/Alfika07/puter/issues/2067)) ([cea94d1](https://github.com/Alfika07/puter/commit/cea94d16cbcdc2185b66feaf225c28647c9d95fb))
* **backend:** race condition in hashing_stream ([8e418a1](https://github.com/Alfika07/puter/commit/8e418a11a11993172c2abaa5c2f33c4728235842))
* bad acl check returning early ([#1789](https://github.com/Alfika07/puter/issues/1789)) ([760bc22](https://github.com/Alfika07/puter/commit/760bc227430c3a7fe91054345cfbbc3ea2b6c199))
* bad ai calls ([#2144](https://github.com/Alfika07/puter/issues/2144)) ([9e2ae1c](https://github.com/Alfika07/puter/commit/9e2ae1c004103aa7537f06073f9b1d97c48ff7b1))
* bad amount of sql params ([#1879](https://github.com/Alfika07/puter/issues/1879)) ([98cf4bb](https://github.com/Alfika07/puter/commit/98cf4bbb081249cfa1d950e715853ded8f7f722c))
* bad amount of sql params ([#1880](https://github.com/Alfika07/puter/issues/1880)) ([89a3a32](https://github.com/Alfika07/puter/commit/89a3a3228f5bd1fe629bd98cf7464801261fef64))
* bad caching query crashing our db ([#2172](https://github.com/Alfika07/puter/issues/2172)) ([25221e5](https://github.com/Alfika07/puter/commit/25221e539d1f9111180babd750448f4e266415dd))
* bad export ([a397707](https://github.com/Alfika07/puter/commit/a397707c7bf86153a611e7ca8045028c8854176a))
* bad method name for together ai ([#2128](https://github.com/Alfika07/puter/issues/2128)) ([1a0e2d3](https://github.com/Alfika07/puter/commit/1a0e2d3def174ea4073087fb169d01f495a1680f))
* bad naming ([#1878](https://github.com/Alfika07/puter/issues/1878)) ([7085bcb](https://github.com/Alfika07/puter/commit/7085bcbb93171eeaf8fc21ed969da1f5536e5547))
* bad usageType ([#2157](https://github.com/Alfika07/puter/issues/2157)) ([f3e143e](https://github.com/Alfika07/puter/commit/f3e143e74a5cec6016cde7bb619e12cd9f350dc3))
* bad wrapper wrap ([#1908](https://github.com/Alfika07/puter/issues/1908)) ([490cd45](https://github.com/Alfika07/puter/commit/490cd4533646c64058645ca8ca861d43a49914d5))
* batch app info referral ([#2146](https://github.com/Alfika07/puter/issues/2146)) ([aa225e3](https://github.com/Alfika07/puter/commit/aa225e3049b86e47941e3cc2088fff29a3bfafbc))
* cache get_app result with expiry to lessen load on db ([#2229](https://github.com/Alfika07/puter/issues/2229)) ([174e613](https://github.com/Alfika07/puter/commit/174e6130ee7fd4337cdcc21613dc1485d7e745e1))
* check if system_prompts is an empty array ([d7ea676](https://github.com/Alfika07/puter/commit/d7ea6769cb47a97ccf4b743e343ea42712eab0cd))
* dbkv raw import ([#1848](https://github.com/Alfika07/puter/issues/1848)) ([ff9932b](https://github.com/Alfika07/puter/commit/ff9932b2f38d4e64de15937bcc410bc664d945f3))
* desktop_items in whoami ([7b38131](https://github.com/Alfika07/puter/commit/7b38131b65ddd415a15f68918482aa339a2926ea))
* do not animate non-existing captcha modal ([ec50536](https://github.com/Alfika07/puter/commit/ec505366e6e9bb46ca9279c91566557f51382ba4))
* don't cache nor fetch raw b64 url for app icons ([#2230](https://github.com/Alfika07/puter/issues/2230)) ([f3b5e1b](https://github.com/Alfika07/puter/commit/f3b5e1b03f233dda757c283626ead7865c2a97a4))
* don't load bench.js files ([#2207](https://github.com/Alfika07/puter/issues/2207)) ([91e12f6](https://github.com/Alfika07/puter/commit/91e12f68866e731e19db83bd6ecd359ab9779906))
* don't set metadata until migration ([#1886](https://github.com/Alfika07/puter/issues/1886)) ([823c06c](https://github.com/Alfika07/puter/commit/823c06c371e0535405333be8b8b3f0ebb0e2d290))
* downgrade opentelemetry so it works again ([1d7a5b7](https://github.com/Alfika07/puter/commit/1d7a5b7c588397090552fd344c19f89824367c17))
* eleven labs metering costs ([#2112](https://github.com/Alfika07/puter/issues/2112)) ([910e604](https://github.com/Alfika07/puter/commit/910e6041fa86266165e5647a91238721c5950572))
* Enable godmode for dev-center to open worker files in editor ([#2224](https://github.com/Alfika07/puter/issues/2224)) ([677426c](https://github.com/Alfika07/puter/commit/677426cbe7868c4fe4b5da1e980568f5507dc36c))
* error calling .startsWith on null mime_type ([656a01f](https://github.com/Alfika07/puter/commit/656a01f2fab7fc04851bcbca534cbbe882b707cd))
* eslint autofixable errors ([#2002](https://github.com/Alfika07/puter/issues/2002)) ([11e0575](https://github.com/Alfika07/puter/commit/11e057557dc593f3ca6a18c363b0880acb60b255))
* explicit actor not passed to fs provider ([3aadaf8](https://github.com/Alfika07/puter/commit/3aadaf84203f3a042ba67d2b66ffee1a631bdf22))
* fallback models ([#2005](https://github.com/Alfika07/puter/issues/2005)) ([262b359](https://github.com/Alfika07/puter/commit/262b3596331ed98371bf68d0b0b94e281d8d4284))
* **fs:** better errors for unresolved selectors ([7cc7907](https://github.com/Alfika07/puter/commit/7cc79077d1833969b3460d2f881b212682e9a6db))
* fsNode.is() requiring unnecessary fetch ([3fe6b8d](https://github.com/Alfika07/puter/commit/3fe6b8d23a786b45e351972e32bf40ae37926f2b))
* get subdomains permission working ([237dc2e](https://github.com/Alfika07/puter/commit/237dc2ef9a91e74e2979d5a7caad22efe67df8c9))
* husky ([#2260](https://github.com/Alfika07/puter/issues/2260)) ([13f7d7b](https://github.com/Alfika07/puter/commit/13f7d7b5028994106a6f0fa9c2b0e770691cc189))
* **i18n:** complete and clean up German translation ([#1893](https://github.com/Alfika07/puter/issues/1893)) ([4e91774](https://github.com/Alfika07/puter/commit/4e91774b9597e75196792c5ce90992b61d4826c1))
* id2path import ([fb41eaa](https://github.com/Alfika07/puter/commit/fb41eaae23cdd7bf6af5a14284b0f497099e0ff8))
* import issues on run form benchmarks (somehow) ([c43f399](https://github.com/Alfika07/puter/commit/c43f3990d9b1ebda448a6288b5c732f68a08a4f7))
* improve response error handling in Perms module ([11a1807](https://github.com/Alfika07/puter/commit/11a18078be78aef5ded5fcc5d87700e0bdbf50d5))
* inaccurate error on update of non-existing ([cf9a867](https://github.com/Alfika07/puter/commit/cf9a867190bc938133936bf5e7b3018cd1c87472))
* incorrect implementation of ll_mkdir ([6a2cac5](https://github.com/Alfika07/puter/commit/6a2cac5d573138779aeedea3f4e43882c9640ed9))
* incorrect variable ref in hl_move for shared ([d429d2f](https://github.com/Alfika07/puter/commit/d429d2f5bc355a75ab070e141c2d743b563a7383))
* issues creating shortcuts ([a5bbc7e](https://github.com/Alfika07/puter/commit/a5bbc7e95b6d8fb559827813df59c6ce06deab57)), closes [#2200](https://github.com/Alfika07/puter/issues/2200)
* lessen alert triggering for metering ([#1837](https://github.com/Alfika07/puter/issues/1837)) ([fd8a88b](https://github.com/Alfika07/puter/commit/fd8a88b8f4bb784ff4f45ed38f0ce093418e95c6))
* make cache calls async on boot ([#2173](https://github.com/Alfika07/puter/issues/2173)) ([6652a1d](https://github.com/Alfika07/puter/commit/6652a1d33259647762468b9795b8c3e05948ae15))
* metering service alerts + missing claude costs ([#2058](https://github.com/Alfika07/puter/issues/2058)) ([f120bc9](https://github.com/Alfika07/puter/commit/f120bc9c584879a423d3f6b04e55ae9c68ff8ecb))
* minor issue in root package.json ([d665149](https://github.com/Alfika07/puter/commit/d6651498eb39d247bba32ca71a59dcd14f80de32))
* missing published/attached website icon for folder on different views ([#1764](https://github.com/Alfika07/puter/issues/1764)) ([#1945](https://github.com/Alfika07/puter/issues/1945)) ([2b8081d](https://github.com/Alfika07/puter/commit/2b8081d10087a5b668f315f1db3b56e8bfdb7175))
* missing video gen ai services in ai module ([#2180](https://github.com/Alfika07/puter/issues/2180)) ([54dd60d](https://github.com/Alfika07/puter/commit/54dd60d44bddbee23443f81085a9d3010cdaf211))
* more strict metering limits, disable ambigious openrouter one ([#2249](https://github.com/Alfika07/puter/issues/2249)) ([7f76bff](https://github.com/Alfika07/puter/commit/7f76bff3f35827cfa8f8c196add7bb4bad0fd3e3))
* move dependency in LocalDiskStorageController ([bb90595](https://github.com/Alfika07/puter/commit/bb90595431c67d7a686b5a0d76ace0efbbf9a69e))
* only fallback to models that are immediately the same ([#2001](https://github.com/Alfika07/puter/issues/2001)) ([f177397](https://github.com/Alfika07/puter/commit/f1773974c068155002c7b7aefc69c0f652210f9c))
* open router cache token metering ([#1988](https://github.com/Alfika07/puter/issues/1988)) ([02d95db](https://github.com/Alfika07/puter/commit/02d95db7edfbc6ff84ca8eaa8fae506a801fb8df))
* openai configuration regression ([16e7fe9](https://github.com/Alfika07/puter/commit/16e7fe985145a72469849b6da9221adf86e3d9b6))
* openrouter costs always being 0 ([#2250](https://github.com/Alfika07/puter/issues/2250)) ([754e820](https://github.com/Alfika07/puter/commit/754e82040379cc855b8eacf961eb41358797aef1))
* openrouter missing usage ([#2008](https://github.com/Alfika07/puter/issues/2008)) ([85d13a9](https://github.com/Alfika07/puter/commit/85d13a9d4b7ed7578494a3f84b11ff3f78173b7b))
* oss boot error fixes ([#2039](https://github.com/Alfika07/puter/issues/2039)) ([001e174](https://github.com/Alfika07/puter/commit/001e174b81aa77a8a8f2c2f758da6cb15a26881f))
* pass exporter to NodeSDK constructor ([87dbb34](https://github.com/Alfika07/puter/commit/87dbb34a8d1c1774cae8f48165619fe0dade11b3))
* possible undefined when handling stuck stream ([813ea63](https://github.com/Alfika07/puter/commit/813ea63d21b345a78ac8046384293833ec3bf7a4))
* prevent loop if failing ai models? ([#2122](https://github.com/Alfika07/puter/issues/2122)) ([8d52cef](https://github.com/Alfika07/puter/commit/8d52cefe476a5401ddb9d65573417953f86e736f))
* **puterfs:** use node `crypto` instead of Web API ([8eee9ad](https://github.com/Alfika07/puter/commit/8eee9ad1dfdb476b4b52d7af214a7e40a33bd507))
* references to `global_config` in puterfs ([705901f](https://github.com/Alfika07/puter/commit/705901fd2b8ffce2d5de49f139ead52863e7250e))
* requestPermission Promise never settled ([3ea309e](https://github.com/Alfika07/puter/commit/3ea309e93b76b815de60bdbfb79e72ea0bf34038))
* rm another ref to storage, rm dupe meter ([db8f45f](https://github.com/Alfika07/puter/commit/db8f45f3867462ffd9932b85334679489250f18a))
* simplify export import typedef ([#1818](https://github.com/Alfika07/puter/issues/1818)) ([3fb3cf0](https://github.com/Alfika07/puter/commit/3fb3cf0e60a40e486a320935628b24dca288ff4e))
* size_measure_stream in streamutils ([92d03e5](https://github.com/Alfika07/puter/commit/92d03e55014a6c5bc5d9c492783f6b0455cfa3d7))
* skip cache when checking user:&lt;&gt;:email:read ([ef6dea2](https://github.com/Alfika07/puter/commit/ef6dea2bec1b082e764a90cacf3893bb6c39674b))
* stricten undef checks ([#2082](https://github.com/Alfika07/puter/issues/2082)) ([cce2c4a](https://github.com/Alfika07/puter/commit/cce2c4ac27b15c506dcec414f94786f1242808e8))
* Switch to new OpenAI Moderation model ([#1826](https://github.com/Alfika07/puter/issues/1826)) ([20601ce](https://github.com/Alfika07/puter/commit/20601ce5e4b953a5787e83677919425a519714b1))
* TelemetryService ([#2077](https://github.com/Alfika07/puter/issues/2077)) ([3c579dc](https://github.com/Alfika07/puter/commit/3c579dcc0d971327a49d9cf290decedbdee8329d))
* throw error not lorem when moderation fails ([5b16774](https://github.com/Alfika07/puter/commit/5b16774a9a8007fcdcf8978a3302e5951883ad52))
* together ai image prices ([#2130](https://github.com/Alfika07/puter/issues/2130)) ([04c8b06](https://github.com/Alfika07/puter/commit/04c8b06616c703fba45dce8e6ee1f49c3040e4f2))
* ts extensions ([#2247](https://github.com/Alfika07/puter/issues/2247)) ([93afbe4](https://github.com/Alfika07/puter/commit/93afbe4dd9f8928ba750c6e7eba80fab0360dfd4))
* ts issue when building for deploy ([#1890](https://github.com/Alfika07/puter/issues/1890)) ([11d2515](https://github.com/Alfika07/puter/commit/11d2515cb283bba0cf9d12610170d9b751d28f20))
* tsconfig to ignore vite config files ([#2048](https://github.com/Alfika07/puter/issues/2048)) ([cb66c56](https://github.com/Alfika07/puter/commit/cb66c56a6b39f82cf620506f1c1d77965d6c54c3))
* types and tests? ([#2193](https://github.com/Alfika07/puter/issues/2193)) ([a661752](https://github.com/Alfika07/puter/commit/a6617527dbcdaee4816bfe8cf76f2d0372012496))
* typo in dbkvStore ([#2066](https://github.com/Alfika07/puter/issues/2066)) ([e8f00e1](https://github.com/Alfika07/puter/commit/e8f00e112175079ef1573b9235c0c8cd3ff94bca))
* undefined svc_fs ([e735705](https://github.com/Alfika07/puter/commit/e7357054b085e62998f6bede0a054efce4161e85))
* update import in TestService ([e95b0be](https://github.com/Alfika07/puter/commit/e95b0be371f49bd3baed02dc3d0a7d41fe3e2065))
* update MeteringService and add utility for TestKernel ([5f78552](https://github.com/Alfika07/puter/commit/5f785520055a08f55add98510b01cfa000d50a26))
* update validation for permission endpoints ([06d56fd](https://github.com/Alfika07/puter/commit/06d56fd7116a874362a6ecd9bd619702d96fce1c))
* usage limited issue whens treaming ([#1806](https://github.com/Alfika07/puter/issues/1806)) ([c9ab01c](https://github.com/Alfika07/puter/commit/c9ab01cf1ef42c43f8e3ed156be8f16e4a5ff5e8))
* wrong order for telemetery init ([#2078](https://github.com/Alfika07/puter/issues/2078)) ([d3beac0](https://github.com/Alfika07/puter/commit/d3beac0518e214f67a391ae0507d06ba7a3f44f5))
* x86 not booting locally ([#1959](https://github.com/Alfika07/puter/issues/1959)) ([849beec](https://github.com/Alfika07/puter/commit/849beecd4fea614334cfa1004e4b5f6a0dfb2cf1))


### Performance Improvements

* [+] readdirstat_uuid optimized implementation ([9bac2cb](https://github.com/Alfika07/puter/commit/9bac2cba07e65c8a75438fcc8b3d6a3104b1485b))
* condition for re-fetch in fsNode.exists() ([4b31204](https://github.com/Alfika07/puter/commit/4b31204224d6e46de1a4c32aa471f0ab24079355))
* don't await on modifying 'accessed' ([af9a2b8](https://github.com/Alfika07/puter/commit/af9a2b830061d8c7531aa01ecdd1f4c5928b6bd3))
* **es:** generate client-safe objects in parallel ([7228e63](https://github.com/Alfika07/puter/commit/7228e63c8bf4ffefe03a7aa115081fe353314d0a))
* improve parallelization in SQLES ([6edd7de](https://github.com/Alfika07/puter/commit/6edd7debb8198f3846954e347196f829ff0e3863))
* is()/is_above() determine when to fetch ([6c0daf5](https://github.com/Alfika07/puter/commit/6c0daf58c41f81769ccd40f5588fca3ee36834d3))
* make app entries more scalable, avoid writing global entries since its just puter itself and isn't relevant ([#2233](https://github.com/Alfika07/puter/issues/2233)) ([aafdec9](https://github.com/Alfika07/puter/commit/aafdec9b8163c1ab437cda6bb0cc0b433e4c4351))
* more benchmarks ([d3c1fc3](https://github.com/Alfika07/puter/commit/d3c1fc31035eba74aff516723389febecf8f870a))
* more benchmarks (2) ([2c60faf](https://github.com/Alfika07/puter/commit/2c60faf5166f7a1857e69a17125909ac8995deed))
* split implied user-app permissions ([eea9d8b](https://github.com/Alfika07/puter/commit/eea9d8b27e7b5bfe8839c4baca33693f4b118ed7))


### Reverts

* change to ai model names ([#2123](https://github.com/Alfika07/puter/issues/2123)) ([b40ca1d](https://github.com/Alfika07/puter/commit/b40ca1df2c8de867af81af4d8fb8e6ccf3a82380))
* commits for user metadata changes ([#1887](https://github.com/Alfika07/puter/issues/1887)) ([758bef0](https://github.com/Alfika07/puter/commit/758bef0582f3f674541f39591d0bce0ed3d2855b))
* fs metering ([#1790](https://github.com/Alfika07/puter/issues/1790)) ([4b14ef8](https://github.com/Alfika07/puter/commit/4b14ef863c436eaedcdbf14c2cf98a47ce573157))
* single ai image entry point ([#2131](https://github.com/Alfika07/puter/issues/2131)) ([907d0db](https://github.com/Alfika07/puter/commit/907d0db32897323a07721c87c6f1b27e60b44b22))
